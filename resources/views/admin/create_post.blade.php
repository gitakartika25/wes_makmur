      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('namaProduk') is-invalid @enderror" id="" placeholder="Masukkan judul postingan" name="judul">
          </div>
          <div class="form-group">
            <label for="exampleInputName1">Tanggal Dibuat</label>
            <input type="date" class="form-control @error('tanggalDibuat') is-invalid @enderror" id="" placeholder="Masukkan tanggal postingan" name="tanggalDibuat">
          </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control @error('isi') is-invalid @enderror" id="exampleTextarea1" name="isi" rows="4"></textarea>
          </div>
